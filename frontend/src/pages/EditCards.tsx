...
export default function EditCards() {
  ...
  async function handleSave(cardId: string) {
    ...
    try {
      ...
      setError(
        "Failed to save card. Please check your connection and try again.",
      );
    }
  }
  ...
  async function handleDelete(cardId: string) {
    ...
    try {
      ...
      setError(
        "Failed to delete card. Please check your connection and try again.",
      );
    }
  }
  ...
  return (
    <div className="p-4 pb-24 relative">
      <div className="relative z-10">
        ...
        <div
          className="bg-white hand-drawn p-6 w-full max-w-md mx-auto shadow-sm"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="text-xs text-warm-500 hover:text-warm-700 font-semibold"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      {card.front_image_url && (
                        <AuthImage
                          src={card.front_image_url}
                          alt=""
                          className="w-10 h-10 rounded object-cover shrink-0 mr-3"
                        />
                      )}
                      <div className="flex-1 min-w-0">
                        <p className="text-warm-900 text-sm truncate font-semibold">
                          {card.front}
                        </p>
