        ...
        {syncError && !isOffline && (
          <div className="bg-amber-50 border border-amber-200 text-amber-700 text-sm rounded-xl px-4 py-3 mb-4 flex items-center justify-between">
            ...
            <button
              ...
              className="text-amber-500 hover:text-amber-700 font-bold ml-2"
            >
              &times;
            </button>
          </div>
        ...
        {decks.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-warm-400 text-sm mb-6">
              Create your first deck and start learning a new language!
            </p>
            <button
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-warm-500 text-sm mt-0.5">
                      {formatLanguage(deck.source_lang)} →{" "}
                      {formatLanguage(deck.target_lang)}
                    </p>
                  ...
                  <svg
                    className="w-5 h-5 text-warm-300 shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
                ...
                <div className="flex gap-4 mt-3 pt-3 border-t border-warm-200">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(`/decks/${deck.id}/add-card`);
                    }}
                    disabled={isOffline}
