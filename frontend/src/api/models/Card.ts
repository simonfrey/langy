...
export function instanceOfCard(value: object): value is Card {
    ...
    if (!('ease_factor' in value) || value['ease_factor'] === undefined) return false;
    if (!('interval_days' in value) || value['interval_days'] === undefined) return false;
    if (!('repetitions' in value) || value['repetitions'] === undefined) return false;
    if (!('next_review' in value) || value['next_review'] === undefined) return false;
...
export function CardFromJSONTyped(json: any, ignoreDiscriminator: boolean): Card {
    ...
    return {
        ...
        'front': json['front'],
        'back': json['back'],
        'front_image_url': json['front_image_url'] == null ? undefined : json['front_image_url'],
        'back_image_url': json['back_image_url'] == null ? undefined : json['back_image_url'],
